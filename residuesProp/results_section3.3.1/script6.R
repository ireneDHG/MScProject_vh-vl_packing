...
highSD<-read.table("div6propH.txt", header=TRUE, sep="\t")
head(highSD)

lowSD<-read.table("div6propL.txt", header=TRUE, sep="\t")
head(lowSD)
...
#Types amino acids
typeH<-read.table("Rdiv6typeH.txt", header=TRUE, sep="\t")
head(typeH)

typeL<-read.table("Rdiv6typeL.txt", header=TRUE, sep="\t")
head(typeL)
