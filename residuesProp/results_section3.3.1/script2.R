...
highSD<-read.table("div2propH.txt", header=TRUE, sep="\t")
head(highSD)

lowSD<-read.table("div2propL.txt", header=TRUE, sep="\t")
head(lowSD)
...
#Types amino acids
typeH<-read.table("Rdiv2typeH.txt", header=TRUE, sep="\t")
head(typeH)

typeL<-read.table("Rdiv2typeL.txt", header=TRUE, sep="\t")
head(typeL)
