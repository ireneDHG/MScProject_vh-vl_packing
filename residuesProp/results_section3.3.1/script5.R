...
highSD<-read.table("div5propH.txt", header=TRUE, sep="\t")
head(highSD)

lowSD<-read.table("div5propL.txt", header=TRUE, sep="\t")
head(lowSD)
...
#Types amino acids
typeH<-read.table("Rdiv5typeH.txt", header=TRUE, sep="\t")
head(typeH)

typeL<-read.table("Rdiv5typeL.txt", header=TRUE, sep="\t")
head(typeL)
