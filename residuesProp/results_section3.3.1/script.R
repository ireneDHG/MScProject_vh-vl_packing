...
highSD<-read.table("div1propH.txt", header=TRUE, sep="\t")
head(highSD)

lowSD<-read.table("div1propL.txt", header=TRUE, sep="\t")
head(lowSD)
...
#Types amino acids
typeH<-read.table("Rdiv1typeH.txt", header=TRUE, sep="\t")
head(typeH)

typeL<-read.table("Rdiv1typeL.txt", header=TRUE, sep="\t")
head(typeL)
