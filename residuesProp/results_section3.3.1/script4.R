...
highSD<-read.table("div4propH.txt", header=TRUE, sep="\t")
head(highSD)

lowSD<-read.table("div4propL.txt", header=TRUE, sep="\t")
head(lowSD)
...
#Types amino acids
typeH<-read.table("Rdiv4typeH.txt", header=TRUE, sep="\t")
head(typeH)

typeL<-read.table("Rdiv4typeL.txt", header=TRUE, sep="\t")
head(typeL)
