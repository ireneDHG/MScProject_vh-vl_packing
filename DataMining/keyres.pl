...
# Purpose
# =======
#        Create a CSV file with the counts of the amino acids and a numeric output (input 1).
#
#********************************************************************
#
# Assumptions
...
#
#       Usage: perl keyres.pl < ../RedundantChothia_MeanSD.txt
#
#********************************************************************   
# Strategy
# ========
...
#       3. Calculate the counts and add the sd as numeric output
