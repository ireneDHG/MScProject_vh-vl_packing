...
# Purpose
# =======
#        Create a CSV file with the residues in the key determing positions and a nominal class output (input 3).
#
#********************************************************************
#
# Assumptions
...
#
#       Usage: perl positionHL2.pl < ../RedundantChothia_MeanSD.txt
#
#********************************************************************   
# Strategy
# ========
