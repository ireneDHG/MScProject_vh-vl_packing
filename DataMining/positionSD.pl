...
# Purpose
# =======
#        Create a CSV file with the residues in the key determing positions and a numeric output (input 4).
#
#********************************************************************
#
# Assumptions
...
#
#       Usage: perl positionSD.pl < ../RedundantChothia_MeanSD.txt
#
#********************************************************************   
# Strategy
# ========
...
#       3. Add the sd as the numeric output
...
#check the undef
my $name = "AllposSD";
my @pos = ("L38","L40","L41","L44","L46","L87","H33","H42","H45","H60","H62","H91","H105");
