...
# Purpose
# =======
#        Create a CSV file with the residues in the relevant key determing positions and a numeric output (input 4).
#
#********************************************************************
#
# Assumptions
...
#
#       Usage: perl attributePosSD.pl < ../RedundantChothia_MeanSD.txt
#
#********************************************************************   
# Strategy
# ========
...
#       3. Add the residues to the positions
