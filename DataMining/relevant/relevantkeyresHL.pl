...
# Script name:  relevantkeyresHL.pl
# Version:      V1.1
# Date:         19/08/16
#
#********************************************************************
...
# Purpose
# =======
#        Create a CSV file with the counts of the relevant key determing residues and a nominal class output (input 1).
#
#********************************************************************
#
# Assumptions
...
#
#       Usage: perl relevantkeyresHL.pl < ../RedundantChothia_MeanSD.txt
#
#********************************************************************   
# Strategy
# ========
...
#       4. Add the counts of the amino acids
